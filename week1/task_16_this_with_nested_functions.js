...
// In this way, the this inside the arrow function still refers to the Car object, allowing it to access the brand property. If we use a regular function declaration, we might need to use additional technique like binding to ensure that this refers to the correct context.
