...
exports.requestCoffeeMachineQueueLength =
  exports.requestCurrentServerTime =
  exports.requestUsers =
  exports.requestAdmins =
    void 0;
var admins = [
...
function logPerson(person) {
  console.log(
    " - "
      .concat(person.name, ", ")
      .concat(person.age, ", ")
      .concat(person.type === "admin" ? person.role : person.occupation)
  );
}
    ...
    requestUsers(function (usersResponse) {
      ...
      requestCurrentServerTime(function (serverTimeResponse) {
        ...
        if (serverTimeResponse.status === "success") {
          console.log(
            "   ".concat(new Date(serverTimeResponse.data).toLocaleString())
          );
        } else {
          return callback(new Error(serverTimeResponse.error));
        }
        console.log();
        requestCoffeeMachineQueueLength(function (
...
startTheApp(function (e) {
  ...
  if (e) {
    console.log(
      'Error: "'.concat(
        e.message,
        "\", but it's fine, sometimes errors are inevitable."
      )
    );
  } else {
    console.log("Success!");
